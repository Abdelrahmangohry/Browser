...
import com.example.browser.activity.MainActivity
import com.example.browser.activity.changeTab
import com.example.browser.database.PreferencesGateway
import com.example.browser.databinding.FragmentBrowseBinding
...
//    private var isBlacklistedChecked = false
//    private var isWhitelistedChecked = false
//    private lateinit var blockedWebsites: List<String>
//    private lateinit var allowedWebsites: List<String>

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_browse, container, false)
        binding = FragmentBrowseBinding.bind(view)
        registerForContextMenu(binding.webView)
//        preferences = PreferencesGateway(requireContext())

        // Load preferences
//        isBlacklistedChecked = preferences.loadBoolean("WebBlacklist", false)
//        isWhitelistedChecked = preferences.loadBoolean("WebWhitelist", false)
//        blockedWebsites = preferences.getList("blockedWebsites")
...
//            }
//
//            loadUrl(urlNew) // Load initial URL
//        }
//    }
    @SuppressLint("SetJavaScriptEnabled", "ClickableViewAccessibility")
